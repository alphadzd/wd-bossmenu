...
-- Get job data
QBCore.Functions.CreateCallback('wd-bossmenu:server:GetJobData', function(source, cb, jobName)
    local src = source
...
function StartRefreshTimer(src, jobName)
    ...
    RefreshTimers[src] = SetTimeout(interval, function()
        ...
        if Player and Player.PlayerData.job.name == jobName then
            ...
            TriggerClientEvent('wd-bossmenu:client:RefreshData', src)
...
-- Get user settings
QBCore.Functions.CreateCallback('wd-bossmenu:server:GetSettings', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('wd-bossmenu:server:UpdateEmployee', function(citizenid, jobName, grade)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    return
        ...
        if targetPlayer then
            ...
            if targetCurrentJob == jobName then
                ...
                targetPlayer.Functions.SetJob(jobName, grade)
                TriggerClientEvent('wd-bossmenu:client:JobChanged', -1, jobName)
...
-- Hire new employee
RegisterNetEvent('wd-bossmenu:server:HireEmployee', function(targetId, jobName, grade)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('wd-bossmenu:server:RemoveEmployee', function(citizenid, jobName)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
-- Save user settings
RegisterNetEvent('wd-bossmenu:server:SaveSettings', function(settings)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('QBCore:Server:OnJobUpdate', function(source, newJob)
    ...
    if Player then
        ...
        TriggerClientEvent('wd-bossmenu:client:JobChanged', -1, newJob.name)
    end
end)
...
QBCore.Commands.Add('managejob', 'Open job management interface', {}, false, function(source)
    ...
    TriggerClientEvent('wd-bossmenu:client:TriggerOpenManager', source, {jobData = jobName})
end)

RegisterNetEvent('wd-bossmenu:server:RefreshPlayTime', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
function LoadSocietyTransactions()
    ...
    if result and #result > 0 then
        ...
        print("^2[wd-bossmenu]^7 No society transactions found in database")
    end
end
...
function GetSocietyData(jobName)
    ...
    if Config.BankingSystem == "wd-banking" then
...
QBCore.Functions.CreateCallback('wd-bossmenu:server:GetSocietyData', function(source, cb, jobName)
    local src = source
...
RegisterNetEvent('wd-bossmenu:server:DepositMoney', function(amount, note, jobName)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('wd-bossmenu:server:WithdrawMoney', function(amount, note, jobName)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('wd-bossmenu:server:TransferMoney', function(citizenid, amount, note, jobName)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('wd-bossmenu:server:SubmitApplication', function(jobName, answers)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback('wd-bossmenu:server:GetJobApplications', function(source, cb, jobName)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('wd-bossmenu:server:UpdateApplicationStatus', function(applicationId, status, notes)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback('wd-bossmenu:server:CheckPendingApplication', function(source, cb, jobName)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback('wd-bossmenu:server:CheckApplicationStatus', function(source, cb, jobName)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('wd-bossmenu:server:RequestRefreshJobData', function()
    TriggerEvent('QBCore:server:UpdateObject')
end)
...
QBCore.Functions.CreateCallback('wd-bossmenu:server:GetEmployeePermissions', function(source, cb, citizenid, jobName)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback('wd-bossmenu:server:UpdateEmployeePermissions', function(source, cb, citizenid, jobName, permissions)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    MySQL.Async.execute('INSERT INTO job_employee_permissions (citizenid, job, permissions, granted_by) VALUES (?, ?, ?, ?) ON DUPLICATE KEY UPDATE permissions = ?, granted_by = ?', 
        ...
        if rowsChanged > 0 then
            ...
            local targetPlayer = QBCore.Functions.GetPlayerByCitizenId(citizenid)
            if targetPlayer then
                TriggerClientEvent('wd-bossmenu:client:RefreshPermissions', targetPlayer.PlayerData.source, permissions)
            ...
            for _, p in pairs(players) do
                if p.PlayerData.job.name == jobName then
                    TriggerClientEvent('wd-bossmenu:client:SyncPermissions', p.PlayerData.source, citizenid, permissions)
                end
            end
...
QBCore.Functions.CreateCallback('wd-bossmenu:server:HireNewEmployee', function(source, cb, targetId, jobName, grade)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local Target = QBCore.Functions.GetPlayer(tonumber(targetId))
...
QBCore.Functions.CreateCallback('wd-bossmenu:server:HasJobAccess', function(source, cb, jobName)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('wd-bossmenu:server:PermissionAction', function(action, data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback('wd-bossmenu:server:GetPlaytimeData', function(source, cb, jobName)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback('wd-bossmenu:server:GetJobGrades', function(source, cb, jobName)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
